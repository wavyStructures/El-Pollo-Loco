...
CHICKEN_WALKING = ['./img/3_enemies_chicken/chicken_normal/1_walk/1_w.png',
...
SMALL_CHICKEN_WALKING = ['./img/3_enemies_chicken/chicken_small/1_walk/1_w.png',
...
ENDBOSS_WALKING = ['./img/4_enemie_boss_chicken/1_walk/G1.png',
    './img/4_enemie_boss_chicken/1_walk/G2.png',
    './img/4_enemie_boss_chicken/1_walk/G3.png',
    './img/4_enemie_boss_chicken/1_walk/G4.png'
];

ENDBOSS_ALERT = ['./img/4_enemie_boss_chicken/2_alert/G5.png',
...
ENDBOSS_ATTACK = ['./img/4_enemie_boss_chicken/3_attack/G13.png',
...
ENDBOSS_HURT = ['./img/4_enemie_boss_chicken/4_hurt/G21.png',
    './img/4_enemie_boss_chicken/4_hurt/G22.png',
    './img/4_enemie_boss_chicken/4_hurt/G23.png',
];

ENDBOSS_DEAD = ['./img/4_enemie_boss_chicken/5_dead/G24.png',
